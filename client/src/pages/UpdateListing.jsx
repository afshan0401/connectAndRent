...
export default function CreateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => { //this
      const listingId = params.listingId;
      //params is imported and initialized in order to get data from user id in url for showing listing data in this page
    ...
    fetchListing(); //causes asynchronus behaviour using this fn above
  }, []);
...
//submit data to server
  ...
  return (
    ...
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold text-center my-7 dark:text-orangetext">Update Listing</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4  dark:text-darktext">
        <div className="flex flex-col gap-4 flex-1">
          ...
          <input
            type="text"
            placeholder="Name"
            className="border p-3 shadow-md rounded-lg dark:text-black"
            id="name"
            maxLength="80"
            minLength="10"
            required
          ...
          <div className='flex items-center gap-2'>
              <input
                ...
                max='10'
                required
                className='p-3 shadow-md border border-gray-300 rounded-full dark:text-black' onChange={handleChange}
...
<span className='text-xs'>(₹ / month)</span>
        ...
        <p className='font-semibold text-orangetext'>
          ...
          <input onChange={(e) => setFiles(e.target.files)} className='p-3 shadow-md border border-gray-300 rounded-full w-full'
              type='file'
              id='images'
              accept='image/*'
              multiple
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className='p-3 text-red-700 rounded-full border shadow-lg uppercase hover:opacity-75 font-semibold'
                >
                  Delete
                </button>
              </div>
          ...
          <button disabled={loading || uploading} className='p-3 bg-orangetext font-semibold text-white rounded-full uppercase shadow-lg hover:opacity-95 disabled:opacity-80'>{loading ? 'Creating...' : 'Update listing'}
          </button>
